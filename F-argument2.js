// Title: 
// A函数参数1为B函数，A函数返回B函数调用A函数参数2-...的结果

var testFn = function(...value){console.log(...value)};
...
// way2:
(function(...value){
	value[0].bind(Object.create(null), value.slice(1))();
})(testFn,1,2,3,4,5);


// way3: like way2
(function(...value){
	value[0].apply(Object.create(null), value.slice(1));
})(testFn,1,2,3,4,5);


// way4:
var callIt = (testFn) => testFn.apply(null, [].splice.call(arguments, 1));
var callIt = (testFn, ...args) => testFn(...args);
