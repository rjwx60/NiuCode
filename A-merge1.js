...
// way3:
var mergeArray = function(...arrays){
	result = Array.prototype.concat.apply([],arrays);
	return result;
}


// way4: can't handle, last result: [[...],[...],[...]]
// var mergeArray = function(...arrays){
// 	// Array.prototype.push.call(result, ...arrays);
// 	// Array.prototype.unshift.call(result, ...arrays);
// };
