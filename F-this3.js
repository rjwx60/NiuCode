// Title: 
// 返回函数，调用返回函数，返回值为按照调用顺序的参数拼接



// way1:
var fnFunction = (str) => {
	fnFunction.putOut = function(){
		console.log(str);
	}
	return function(anotherStr){
		if(anotherStr){
			str += ', ' + anotherStr;
			return fnFunction(str)
		}else{
			return str;
		}
	};
...
// way2: unknown can' return real result...
// var fnFunction = () => {
//     var args = [].slice.call(arguments, 0);
//     var fn = function() {
//         argusCache = args.concat([].slice.call(arguments, 0));
//         return fnFunction.apply(this, argusCache);
//     };
//     fn.putOut = function() {
...
console.log(fnFunction("Hello")("World")("guys")("&")("girls")())
